...
Kirigami.FormLayout {
    ...
    property alias cfg_showInterference: interference.checked
    ...
    QQC2.CheckBox { id: interference; Kirigami.FormData.label: i18n("Show:"); text: i18n("Interference (glitches, airtime)") }
